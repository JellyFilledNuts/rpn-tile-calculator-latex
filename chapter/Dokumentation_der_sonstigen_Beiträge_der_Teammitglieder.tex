...
In der Tabelle wurden drei Spalten angegeben: \textit{Datum}, \textit{Dauer} und \textit{Beschreibung}. Der Inhalt der jeweiligen Zeile konnte anschließend eingetragen werde. Das Tagebuch konnte anschließend als \code{tng} Datei heruntergeladen werden oder online gespeichert werden. Aus der erstellten Tabelle wurde anschließend der \LaTeX-Code generiert. Auf \hyperlink{www.authorea.com}{Authorea} wurde anschließend der generierte Code in ein PDF-Dokument umgewandelt. 
