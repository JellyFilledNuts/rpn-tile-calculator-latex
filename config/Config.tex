...
% Bestimmte Arten von Linebreaks
\usepackage{parskip}

% Tables that go over several pages
\usepackage{longtable}

% So that figures don't fly around.
\usepackage[section]{placeins}

% Fight footnotes flying around.
...
\usepackage[
    ...
    firstinits=true,         % false = Vornamen werden ausgeschrieben
    natbib=true,
...
\definecolor{shkeyword}{rgb}{0.37, 0.08, 0.25}
\definecolor{shstring}{rgb}{0.06, 0.10, 0.98}
